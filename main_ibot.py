...
from loader import ImageFolderMask, Cifar100Mask
...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='vit_small', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base', 'vit_large', 'deit_tiny', 'deit_small',
                 'swin_tiny','swin_small', 'swin_base', 'swin_large', 'vim_tiny', 'vim_small', 'vim_base'],
...
def train_ibot(args):
    ...
    student = utils.MultiCropWrapper(student, iBOTHead(
        ...
        use_middle_cls_token=getattr(student, 'use_middle_cls_token', False),
    ))
    teacher = utils.MultiCropWrapper(
        ...
        iBOTHead(
            ...
            use_middle_cls_token=getattr(teacher, 'use_middle_cls_token', False),
        ),
    )
